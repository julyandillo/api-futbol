...
/**
 * @extends ServiceEntityRepository<Aplicacion>
 *
...
class AplicacionRepository extends ServiceEntityRepository
{
    ...
    public function save(Aplicacion $entity, bool $flush = false): void
    {
    ...
    public function remove(Aplicacion $entity, bool $flush = false): void
    {
